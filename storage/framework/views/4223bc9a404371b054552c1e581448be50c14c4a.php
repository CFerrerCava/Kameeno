<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="/assets_client/theme-assets/images/backgrounds/02.jpg">
    <div class="navbar-header">
      <ul class="nav navbar-nav flex-row">
        <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="Chameleon admin logo" src="/assets_client/theme-assets/images/logo/logo.png"/>
...
<?php /**PATH C:\Users\RobertGutierrez\Desktop\Nortec\Kameeno\kameeno\resources\views\client\components\sidenav.blade.php ENDPATH**/ ?>